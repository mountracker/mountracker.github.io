 ...
 * The Custom Style for SKT Watch
...
/*-----------------------------COLORS------------------------------------*/
		...
		.slider-main .nivo-caption .slidebtn2 a{ 
			...
			color:<?php echo $complete['sldbtntext_color_id2']; ?>; border-color:<?php echo $complete['sldbtn_color_id2']; ?>;

		}	

		.slider-main .nivo-caption .slidebtn2 a:hover{background-color:<?php echo $complete['sldbtn_hvcolor_id2']; ?>; border-color:<?php echo $complete['sldbtn_hvcolor_id2']; ?>; color:<?php echo $complete['sldbtn_hvtextcolor_id2']; ?>;}
...
.footer-infobox{background-color: <?php echo $complete['footer_infobox_bg_color']; ?>;}

.footer-infobox .footer-infobox-title{color: <?php echo $complete['footer_infobox_title_color']; ?>;}

.footer-infobox .footer-infobox-right{color: <?php echo $complete['footer_infobox_content_color']; ?>;}
