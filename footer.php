...
<div id="footer" class="footer-type<?php echo $footertype; ?>">
    ...
    <?php if($complete['hide_foot_infobox'] != '') { ?> 
		<div class="footer-infobox footer-infobox-bottom">
        	<div class="center">
                <div class="footer-infobox-left"><h3 class="footer-infobox-title"><?php echo $complete['footer_infobox_bottom_title']; ?></h3></div>
                <div class="footer-infobox-right"><?php echo do_shortcode($complete['footer_infobox_bottom_content']); ?></div>
                <div class="clear"></div>
            </div>
        </div>
    <?php } ?>
